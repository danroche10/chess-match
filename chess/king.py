...
class King(Piece):
    ...
    def get_valid_king_moves(self, board, current_row, current_col, color):
        ...
        self._get_moves_to_right_horizontal(moves, board, current_row, current_col, color)
        self._get_moves_to_left_horizontal(moves, board, current_row, current_col, color)
        ...
        self._get_moves_right_diagonal_down(moves, board, current_row, current_col, color)
        self._get_moves_left_diagonal_up(moves, board, current_row, current_col, color)
        self._get_moves_left_diagonal_down(moves, board, current_row, current_col, color)

        return moves
        
    def _get_moves_to_right_horizontal(self, moves, board, current_row, current_col, color):
        if current_col <= 6:
    ...
    def _get_moves_to_left_horizontal(self, moves, board, current_row, current_col, color):
        if current_col >=1:
            if board[current_row][current_col-1] == 0:
                moves = Helpers.update_valid_moves(moves, current_row, current_col-1)
            elif (board[current_row][current_col-1].get_color() == WHITE and color == BLACK) or (board[current_row][current_col-1].get_color() == BLACK and color == WHITE):
    ...
    def _get_moves_right_diagonal_up(self, moves, board, current_row, current_col, color):
    ...
    def _get_moves_right_diagonal_down(self, moves, board, current_row, current_col, color):
    ...
    def _get_moves_left_diagonal_up(self, moves, board, current_row, current_col, color):
    ...
    def _get_moves_left_diagonal_down(self, moves, board, current_row, current_col, color):
